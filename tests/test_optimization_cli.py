...
from src.aws_cost_cli.cost_optimizer import (
    ...
    OptimizationType, SeverityLevel
)
...
class TestOptimizationCLI:
    ...
    def test_optimize_command_default(self, mock_optimizer_class, mock_credential_manager, runner, mock_optimizer_report):
        ...
        assert "Analysis period: Last" in result.output and "30" in result.output and "days" in result.output
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_optimize_command_with_profile_and_days(self, mock_optimizer_class, mock_credential_manager, runner, mock_optimizer_report):
        ...
        result = runner.invoke(cli, ['optimize', '--profile', 'production', '--days', '60'])
        
        assert result.exit_code == 0
        assert "Analysis period: Last" in result.output and "60" in result.output and "days" in result.output
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_optimize_command_json_output(self, mock_optimizer_class, mock_credential_manager, runner, mock_optimizer_report):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    def test_optimize_command_invalid_credentials(self, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_optimize_command_no_recommendations(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_default(self, mock_optimizer_class, mock_credential_manager, runner):
        ...
        assert "Analysis period: Last" in result.output and "7" in result.output and "days" in result.output
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_with_filters(self, mock_optimizer_class, mock_credential_manager, runner):
        ...
        assert result.exit_code == 0
        assert "Analysis period: Last" in result.output and "14" in result.output and "days" in result.output
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_no_anomalies(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_filtered_by_threshold(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_service_filter(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    def test_detect_anomalies_command_invalid_credentials(self, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_optimize_command_exception_handling(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_command_exception_handling(self, mock_optimizer_class, mock_credential_manager, runner):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_optimize_command_recommendations_display(self, mock_optimizer_class, mock_credential_manager, runner, mock_optimizer_report):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cost_optimizer.CostOptimizer')
    def test_detect_anomalies_recommendations_display(self, mock_optimizer_class, mock_credential_manager, runner):
