...
class TestConfigManager:
    ...
    def test_load_yaml_config_file(self):
        ...
        config_data = {
            ...
            "llm_config": {"anthropic": {"api_key": "test-key"}},
        }
    ...
    def test_load_json_config_file(self):
        ...
        config_data = {
            ...
            "llm_config": {"bedrock": {"region": "us-west-2"}},
        }
    ...
    def test_invalid_yaml_config(self):
        ...
        try:
            manager = ConfigManager()
            with pytest.raises(
                ConfigurationError, match="Invalid configuration file format"
            ):
    ...
    def test_save_yaml_config(self):
        ...
        config = Config(
            llm_provider="anthropic", cache_ttl=7200, output_format="detailed"
        )
    ...
    def test_auto_discover_config_file(self):
        ...
        with tempfile.NamedTemporaryFile(
            mode="w", suffix=".aws-cost-cli.yaml", delete=False
        ) as f:
            yaml.dump(config_data, f)
            config_path = f.name
