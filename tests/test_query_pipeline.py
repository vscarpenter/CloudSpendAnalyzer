...
class TestQueryPipeline:
    ...
    def test_successful_query_processing(self, mock_format_response, mock_get_cost_data, 
                                       mock_validate_params, mock_parse_query, 
                                       mock_validate_permissions, mock_validate_credentials):
        ...
        mock_parse_query.assert_called_once_with("How much did I spend on EC2 last month?")
    ...
    @patch('src.aws_cost_cli.aws_client.CredentialManager.validate_credentials')
    @patch('src.aws_cost_cli.aws_client.AWSCostClient.validate_permissions')
    def test_permissions_validation_failure(self, mock_validate_permissions, mock_validate_credentials):
    ...
    @patch('src.aws_cost_cli.aws_client.AWSCostClient.validate_permissions')
    @patch('src.aws_cost_cli.query_processor.QueryParser.parse_query')
    def test_query_parsing_failure(self, mock_parse_query, mock_validate_permissions, mock_validate_credentials):
    ...
    @patch('src.aws_cost_cli.query_processor.QueryParser.parse_query')
    @patch('src.aws_cost_cli.query_processor.QueryParser.validate_parameters')
    def test_parameter_validation_failure(self, mock_validate_params, mock_parse_query, 
                                        mock_validate_permissions, mock_validate_credentials):
    ...
    @patch('src.aws_cost_cli.aws_client.AWSCostClient.get_cost_and_usage')
    @patch('src.aws_cost_cli.response_formatter.ResponseGenerator.format_response')
    def test_cache_hit(self, mock_format_response, mock_get_cost_data, mock_get_cached_data,
                      mock_validate_params, mock_parse_query, mock_validate_permissions, 
    ...
    @patch('src.aws_cost_cli.aws_client.AWSCostClient.get_cost_and_usage')
    @patch('src.aws_cost_cli.response_formatter.ResponseGenerator.format_response')
    def test_fresh_data_request(self, mock_format_response, mock_get_cost_data, mock_get_cached_data,
                               mock_validate_params, mock_parse_query, mock_validate_permissions, 
                               mock_validate_credentials):
...
class TestQueryPipelineHelpers:
    ...
    def test_handle_ambiguous_query_cost_type(self):
        ...
        assert len(suggestions) > 0
        assert any("total" in suggestion.lower() or "breakdown" in suggestion.lower() 
...
class TestQueryPipelineFallback:
    ...
    @patch('src.aws_cost_cli.aws_client.AWSCostClient.get_cost_and_usage')
    @patch('src.aws_cost_cli.response_formatter.ResponseGenerator.format_response')
    def test_llm_fallback_to_pattern_matching(self, mock_format_response, mock_get_cost_data,
                                             mock_validate_params, mock_convert_params,
                                             mock_fallback_parse, mock_parse_query,
                                             mock_validate_permissions, mock_validate_credentials):
        ...
        # Mock LLM failure
        mock_parse_query.side_effect = LLMProviderError("LLM not available", provider="openai")
