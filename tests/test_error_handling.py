...
from src.aws_cost_cli.query_processor import QueryParser, OpenAIProvider, AnthropicProvider, OllamaProvider
...
class TestCustomExceptions:
    ...
    def test_llm_provider_error(self):
        ...
        error = LLMProviderError("Test error", provider="openai", fallback_available=True)
        assert "Test error" in error.message
...
class TestErrorHandlers:
    ...
    def test_format_error_message(self):
        ...
        # Without suggestions
        message_without_suggestions = format_error_message(error, include_suggestions=False)
...
class TestAWSClientErrorHandling:
    ...
    def test_credential_manager_validate_credentials_no_credentials(self, mock_session):
        ...
        mock_session.return_value.client.return_value.get_caller_identity.side_effect = NoCredentialsError()
    ...
    def test_aws_client_network_error(self, mock_session):
        ...
        mock_client.get_cost_and_usage.side_effect = EndpointConnectionError(endpoint_url="https://ce.us-east-1.amazonaws.com")
