...
class TestCLI:
    ...
    def test_query_command_success(self, mock_response_gen, mock_query_parser, 
                                 mock_cache_manager, mock_aws_client, 
    ...
    @patch('src.aws_cost_cli.cli.ConfigManager')
    @patch('src.aws_cost_cli.cli.CredentialManager')
    def test_query_command_invalid_credentials(self, mock_credential_manager, mock_config_manager):
    ...
    @patch('src.aws_cost_cli.cli.CredentialManager')
    @patch('src.aws_cost_cli.cli.AWSCostClient')
    def test_query_command_insufficient_permissions(self, mock_aws_client, 
                                                  mock_credential_manager, mock_config_manager):
    ...
    @patch('src.aws_cost_cli.cli.CacheManager')
    @patch('src.aws_cost_cli.cli.QueryParser')
    def test_query_command_parse_error(self, mock_query_parser, mock_cache_manager,
                                     mock_aws_client, mock_credential_manager, mock_config_manager):
        """Test query command with query parsing error."""
        mock_config_manager.return_value.load_config.return_value = self.config
        mock_credential_manager.return_value.validate_credentials.return_value = True
        mock_aws_client.return_value.validate_permissions.return_value = True
        mock_query_parser.return_value.parse_query.side_effect = Exception("Parse error")
    ...
    @patch('src.aws_cost_cli.cli.CacheManager')
    @patch('src.aws_cost_cli.cli.QueryParser')
    def test_query_command_aws_api_error(self, mock_query_parser, mock_cache_manager,
                                       mock_aws_client, mock_credential_manager, mock_config_manager):
        ...
        mock_cache_manager.return_value.get_cached_data.return_value = None
        mock_cache_manager.return_value.generate_cache_key.return_value = 'test-key'
        mock_aws_client.return_value.get_cost_and_usage.side_effect = Exception("AWS API Error")
    ...
    @patch('src.aws_cost_cli.cli.QueryParser')
    @patch('src.aws_cost_cli.cli.ResponseGenerator')
    def test_query_command_with_cache(self, mock_response_gen, mock_query_parser,
                                    mock_cache_manager, mock_aws_client,
                                    mock_credential_manager, mock_config_manager):
    ...
    @patch('src.aws_cost_cli.cli.QueryParser')
    @patch('src.aws_cost_cli.cli.ResponseGenerator')
    def test_query_command_fresh_flag(self, mock_response_gen, mock_query_parser,
                                    mock_cache_manager, mock_aws_client,
                                    mock_credential_manager, mock_config_manager):
        ...
        result = self.runner.invoke(cli, ['query', 'How much did I spend on EC2?', '--fresh'])
    ...
    @patch('src.aws_cost_cli.cli.CacheManager')
    @patch('src.aws_cost_cli.cli.QueryParser')
    def test_query_command_json_output(self, mock_query_parser, mock_cache_manager,
                                     mock_aws_client, mock_credential_manager, mock_config_manager):
    ...
    def test_list_profiles_command(self, mock_credential_manager):
        ...
        mock_credential_manager.return_value.validate_credentials.side_effect = [
            True, True, False  # default and production valid, staging invalid
        ]
    ...
    @patch('src.aws_cost_cli.cli.CacheManager')
    @patch('src.aws_cost_cli.cli.QueryParser')
    def test_test_command(self, mock_query_parser, mock_cache_manager,
                         mock_aws_client, mock_credential_manager, mock_config_manager):
        """Test the test command."""
        mock_config_manager.return_value.load_config.return_value = self.config
        mock_credential_manager.return_value.get_available_profiles.return_value = ['default']
        mock_credential_manager.return_value.validate_credentials.return_value = True
        mock_aws_client.return_value.validate_permissions.return_value = True
        mock_query_parser.return_value.parse_query.return_value = self.query_params
