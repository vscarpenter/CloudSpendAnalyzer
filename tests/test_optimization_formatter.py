...
class TestOptimizationFormatter:
    ...
    def sample_report(self):
        ...
        return OptimizationReport(
            ...
            total_potential_savings=CostAmount(amount=Decimal('245.0')),  # 50 + 75 + 120
    ...
    def test_format_recommendations_by_type(self, formatter, sample_report):
        ...
        formatted = formatter._format_recommendations_by_type(sample_report.recommendations)
    ...
    def test_get_type_title(self, formatter):
        ...
        assert formatter._get_type_title(OptimizationType.UNUSED_RESOURCES) == "Unused Resources"
        assert formatter._get_type_title(OptimizationType.RIGHTSIZING) == "Rightsizing Opportunities"
        assert formatter._get_type_title(OptimizationType.RESERVED_INSTANCES) == "Reserved Instance Recommendations"
        assert formatter._get_type_title(OptimizationType.SAVINGS_PLANS) == "Savings Plan Opportunities"
    ...
    def test_format_recommendations_summary(self, formatter, sample_report):
        ...
        summary = formatter.format_recommendations_summary(sample_report.recommendations)
