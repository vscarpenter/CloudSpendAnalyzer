...
from src.aws_cost_cli.cost_optimizer import (
    CostOptimizer, OptimizationReport, OptimizationRecommendation,
    CostAnomaly, BudgetVariance, OptimizationType, SeverityLevel
)
...
class TestCostOptimizer:
    ...
    def test_generate_optimization_report(self, optimizer, analysis_period):
        ...
        optimizer._analyze_rightsizing_opportunities.assert_called_once_with(analysis_period)
    ...
    def test_detect_cost_anomalies(self, optimizer, analysis_period):
        ...
        optimizer._analyze_anomaly_root_cause = Mock(return_value="Service-level cost spike")
    ...
    def test_analyze_budget_variances(self, optimizer, analysis_period):
        ...
        with patch('boto3.Session') as mock_session:
            ...
            optimizer._get_actual_spending_for_budget = Mock(return_value=Decimal('1200.00'))
    ...
    def test_analyze_anomaly_root_cause(self, optimizer):
        ...
        anomaly = {
            ...
            'AnomalyScore': {'CurrentScore': 85.0}
        }
    ...
    def test_get_actual_spending_for_budget(self, optimizer, analysis_period):
        ...
        actual_spending = optimizer._get_actual_spending_for_budget(budget, analysis_period)
    ...
    def test_error_handling_in_analysis_methods(self, optimizer, analysis_period):
        ...
        optimizer.ce_client.get_rightsizing_recommendation.side_effect = Exception("API Error")
