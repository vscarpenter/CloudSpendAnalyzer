...
from src.aws_cost_cli.data_exporter import (
    CSVExporter, JSONExporter, ExcelExporter, EmailReporter, ExportManager
)
from src.aws_cost_cli.models import (
    CostData, CostResult, CostAmount, TimePeriod, QueryParameters, 
    Group, TrendData, ForecastData, TimePeriodGranularity
)
...
class TestCSVExporter:
    ...
    def test_csv_export_basic(self, sample_cost_data, sample_query_params):
        ...
        try:
            result_path = exporter.export(sample_cost_data, sample_query_params, output_path)
    ...
    def test_csv_export_with_trend_and_forecast(self, sample_cost_data, sample_query_params):
...
class TestJSONExporter:
    ...
    def test_json_export_with_trend_and_forecast(self, sample_cost_data, sample_query_params):
...
class TestExcelExporter:
    ...
    def test_excel_export_dependency_error(self, sample_cost_data, sample_query_params):
        ...
        with patch('src.aws_cost_cli.data_exporter.ExcelExporter._check_dependencies') as mock_check:
            mock_check.side_effect = ImportError("openpyxl is required for Excel export")
...
class TestEmailReporter:
    ...
    def test_send_report_basic(self, mock_create_attachments, mock_smtp, 
                              sample_cost_data, sample_query_params):
...
class TestExportManager:
    ...
    def test_export_data_unsupported_format(self, sample_cost_data, sample_query_params):
    ...
    def test_send_email_report(self, mock_send_report, sample_cost_data, sample_query_params):
