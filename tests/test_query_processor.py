...
class TestBedrockProvider:
    ...
    def test_parse_query_titan_success(self, mock_session):
        ...
        provider = BedrockProvider(
            model="amazon.titan-text-express-v1", region="us-east-1"
        )
...
class TestQueryParser:
    ...
    def test_parse_query_complete_failure(self):
        ...
        with patch.object(
            FallbackParser, "parse_query", side_effect=Exception("Parse error")
        ):
            parser = QueryParser(config)
    ...
    def test_multiple_providers_fallback(self):
        ...
        parser._providers = {"provider1": mock_provider1, "provider2": mock_provider2}
