...
class ExcelExporter(DataExporter):
    ...
    def export(
        ...
        self._create_details_sheet(
            details_ws, cost_data, header_font, header_fill, currency_format
        )
    ...
    def _create_details_sheet(
        self, ws, cost_data, header_font, header_fill, currency_format
    ):
    ...
    def _add_cost_chart(self, ws, cost_data):
        ...
        try:
            ...
            data = Reference(
                ...
                max_row=chart_start_row + len(cost_data.results),
            )
...
class EmailReporter:
    ...
    def send_report(
        ...
        attachment_formats: List[str] = None,
    ) -> bool:
        """
        ...
        try:
            ...
            if include_attachments:
                attachments = self._create_attachments(
                    cost_data, query_params, attachment_formats
                )
    ...
    def _create_attachments(
        self, cost_data: CostData, query_params: QueryParameters, formats: List[str]
    ) -> List[tuple]:
