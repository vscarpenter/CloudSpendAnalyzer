...
class DateRangeCalculator:
    ...
    def get_fiscal_quarter_range(self, fiscal_year: int, quarter: Quarter) -> TimePeriod:
        """
    ...
    def get_fiscal_year_range(self, fiscal_year: int) -> TimePeriod:
        ...
        if self.fiscal_year_start_month == 1:
            ...
            start_date = datetime(fiscal_year - 1, self.fiscal_year_start_month, 1, tzinfo=timezone.utc)
            end_date = datetime(fiscal_year, self.fiscal_year_start_month, 1, tzinfo=timezone.utc)
    ...
    def get_previous_period(self, period: TimePeriod, period_type: str = "same_length") -> TimePeriod:
        """
    ...
    def get_quarters_in_range(self, start_date: datetime, end_date: datetime) -> List[Tuple[int, Quarter]]:
        """
        ...
        while current_date < end_date:
            ...
            if quarter == Quarter.Q4:
                ...
                current_date = datetime(year, next_quarter_month, 1, tzinfo=current_date.tzinfo)
        
        return quarters


def parse_advanced_date_range(date_str: str, fiscal_year_start_month: int = 1) -> TimePeriod:
    """
